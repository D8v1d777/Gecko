                            ...
                            findings.append(
                                {
                                    ...
                                    "parameter": param,
                                    "payload": p,
                                    "evidence": "Template injection payload reflected directly into the DOM",
                                    "remediation": "Avoid using server-side input directly in client-side templates, use v-pre or ng-non-bindable",
                                    "cwe": "CWE-94",
                                }
                            )
                            break
