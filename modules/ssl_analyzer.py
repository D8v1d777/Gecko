            ...
            findings.append(
                {
                    ...
                    "severity": "HIGH",
                    "url": url,
                    "evidence": "Unencrypted connection",
                    ...
                    findings.append(
                        {
                            ...
                            "severity": "MEDIUM",
                            "url": f"https://{host}",
                            "evidence": f'Issuer matches subject: {issuer.get("commonName")}',
                            "cwe": "CWE-295",
                        }
                    )
        ...
        for proto, name in weak_protocols:
            ...
            try:
                ...
                if ver:
                    findings.append(
                        {
                            "type": "Weak TLS Version Supported",
                            "severity": "MEDIUM",
                            "url": f"https://{host}",
                            "evidence": f"{name} supported",
                            "remediation": f"Disable {name}",
                            "cwe": "CWE-326",
                        }
                    )
            except:
